...
<div class="register-step-content container">
  <div class="register-step__progress-bar">
    ...
    <form action="#" id="step-form">
      <input type="hidden" name="action" value="grad_final">
      ...
      <div class="register-step__info-row register-step__info-row--yesno">
        <label>If accepted, I will clear my personal and work calendar for the entire duration of the program in order to maximize my ability to fully participate and get the most out of the provided training.</label>
        <div class="register-step__yesno">
      ...
      <div class="register-step__submit-container">
        ...
        <a class="register-step__next-btn" href="<?php echo home_url("/course-registration?step=3&courseNumber=$course_sku"); ?>">Finish Application</a>
      </div>
    </form>
</div>
