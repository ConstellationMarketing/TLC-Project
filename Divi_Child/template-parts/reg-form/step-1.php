<?php
  ...
  update_post_meta( 24105, 'financial_aid', $financial_aid );
  update_post_meta( 24105, 'why_aid', $why_aid );
  update_post_meta( 24105, 'income_range', $income_range );
...
<div class="register-step-content container">
  <div class="register-step__progress-bar">
    ...
    <form action="#" id="step-form">
      <input type="hidden" name="action" value="reg_user_info">
...
<script>
  jQuery(document).ready(function ($) {
    $('.register-step__next-btn').on('click', function (e) {
      ...
      $('.register-step__input-container input.error, .register-step__input-container select.error, .register-step__info-row textarea.error, .register-step__form-row textarea.error').removeClass('error');
