...
<div class="register-step-content container">
  <div class="register-step__progress-bar">
    ...
    <form action="#" id="step-form">
      <input type="hidden" name="action" value="3wk_user_info">
      ...
      <div class="register-step__form-row">
        <div class="register-step__input-container onerow">
          <label for="jury_trials">How many jury trials have you conducted as lead counsel?</label>
          <input class="required" type="number" id="jury_trials" name="jury_trials">
        </div>
      </div>

      <div class="register-step__form-row">
        <div class="register-step__input-container onerow">
          <label for="verdict_trials">How many jury trials have you conducted as lead counsel that reached a verdict?</label>
          <input class="required" type="number" id="verdict_trials" name="verdict_trials">
        </div>
      </div>

      <div class="register-step__form-row">
        <div class="register-step__input-container onerow">
          <label for="exam_trials">How many jury trials have you conducted as co-counsel in which you conducted a direct or cross examination?</label>
          <input class="required" type="number" id="exam_trials" name="exam_trials">
        </div>
      </div>

      <h4>If you practice administrative law:</h4>

      <div class="register-step__form-row">
        <div class="register-step__input-container">
          <label for="hearings">How many administrative hearings as lead counsel?</label>
          <input type="number" id="hearings" name="hearings">
        </div>
      </div>

      <div class="register-step__form-row">
        <div class="register-step__input-container">
          <label for="hearings_nature">What is the primary nature of your administrative hearings?</label>
          <textarea name="hearings_nature" id="hearings_nature" cols="20" rows="3" placeholder="Detailed information about the nature of your administrative hearings."></textarea>
        </div>
      </div>

      <div class="register-step__form-row">
        <div class="register-step__input-container">
          <label for="make_arguments">At your hearings, do you present witnesses and make arguments?</label>
          <textarea name="make_arguments" id="make_arguments" cols="20" rows="3" placeholder="Detailed information about presenting witnesses at your trials."></textarea>
        </div>
      </div>

      <div class="register-step__form-row">
        <div class="register-step__input-container">
          <label for="cases_types">List the types of cases you generally try:</label>
          <textarea class="required" name="cases_types" id="cases_types" cols="20" rows="3" placeholder="Detailed information about the cases you generally try."></textarea>
        </div>
      </div>
      ...
      <div class="register-step__form-row">
        <div class="register-step__input-container">
          <label for="prev_applies">If you’ve previously applied for this course, in which year(s) did you apply?</label>
          <textarea name="prev_applies" id="prev_applies" cols="20" rows="3" placeholder="List the year(s) of prior application(s)"></textarea>
        </div>
      </div>

      <div class="register-step__form-row">
        <div class="register-step__input-container">
          <label for="attended_courses">How many TLC courses have you attended?</label>
          <input type="number" id="attended_courses" name="attended_courses">
        </div>
      </div>
      
      <div class="register-step__form-row">
        <div class="register-step__input-container">
          <label for="recent_course">If you have attended a TLC course before, what was the most recent TLC course you attended?</label>
          <textarea name="recent_course" id="recent_course" cols="20" rows="3" placeholder="Detailed information about the recently attended TLC courses."></textarea>
        </div>
      </div>

      <h3>References</h3>

      <strong>Please provide three references as to your character as a person, and as a lawyer. No relatives, please.</strong>

      <div class="register-step__form-row">
        <div class="register-step__input-container">
          <label for="reference_1">Reference #1</label>
          <textarea class="required" name="reference_1" id="reference_1" cols="20" rows="3" placeholder="Detailed contact information for Reference 1"></textarea>
        </div>
      </div>
      ...
      <div class="register-step__form-row">
        <div class="register-step__input-container">
          ...
          <textarea class="required" name="reference_2" id="reference_2" cols="20" rows="3" placeholder="Detailed contact information for Reference 2"></textarea>
        </div>
      </div>

      <div class="register-step__form-row">
        <div class="register-step__input-container">
          <label for="reference_3">Reference #2</label>
          <textarea class="required" name="reference_3" id="reference_3" cols="20" rows="3" placeholder="Detailed contact information for Reference 3"></textarea>
        </div>
      </div>
