...
<p><?php printf( esc_html__( 'Notification to let you know &mdash; order #%1$s has been cancelled:', 'woocommerce' ), esc_html( $order->get_order_number() ) ); ?></p>
...
echo "<b>The user who placed the order: </b> $first_name $last_name ($user_email)";
/*
